...
<body>
						...
						<ul>
							...
							<li>
								...
								<ul id="buttonUI2" class = button123 style="display: none;">
									...
									<li><a href="Servlet?command=notice&category=all">NOTICE</a>
									</li>
	...
	<div id="main">
		...
		<div class="top2">
			...
			<div class="btnWrap">
				<a class="bg" href="Servlet?command=notice&page=${pageNum}">목록</a>
				<a class="bg" id="upt" href="Servlet?command=noticeUpdatePage&bno=${bno}">수정</a>
				<a class="br"id="del" href="Servlet?command=noticeDelete&bno=${bno}">삭제</a>
				<script>
					$(function() {
					  // 세션 값 가져오기
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td class="bno"><%=bno %></td>
						<td class="title">
							<a href="Servlet?command=noticeDetail&bno=<%=bno%>">
								<span><%=title %></span>
							</a>
						</td>
						<td><%=w_date %></td>
		...
		<div style="clear:both;"></div>
			<div class="page">
				<a id="minus" href="Servlet?command=notice&page=<%=pageNum - 1%>"></a>
				<%for(int i=1; i<=6; i++){
					if(pageNum == i){
				%>
					<a class="on" href="Servlet?command=notice&page=<%=i %>"><%=i %></a>
				<%		
					} else {
				%>
					<a href="Servlet?command=notice&page=<%=i%>"><%=i %></a>
				<%
					}
				}
				%>
				<a id="plus" href="Servlet?command=notice&pageNum=<%=pageNum + 1%>"></a>
			</div>
		</div>
	</div>
	<div style="clear:both;"></div>
