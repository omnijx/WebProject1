...
%>
<% //request.setAttribute("LoginErrMsg", null); %>
<%  
// 	request.removeAttribute("LoginErrMsg"); 

// 	System.out.println("Login.jsp) request.getAttribute LoginErrMsg = " + request.getAttribute("LoginErrMsg"));
%>
<!DOCTYPE html>
<html>
<head>
...
<!-- 								<button type="submit">로그인</button> -->
						...
						<div class="qBox">
							<div class="leftBox">
								...
								<div class="btnWrap">
									<a href="Servlet?command=join1">회원가입</a>
								</div>
							</div>
							<div class="rightBox">
								<p>
