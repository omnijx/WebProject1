				...
				for(let i=0; i<result.length; i++){
					...
					for(let j=0; j<result[i].length; j++){
						...
						if (j === 1) {
					          ...
					          aTag.href = "Servlet?command=noticeDetail&bno="+bnoValue+"&page="+pageNum;
...
<body>
      ...
      <!-- 나옴 -->  	<div class="allList" id="alist" style="display: none;">
        				<div class="list1">
        					...
        					<div class ="list1box" style="width: 150px">
        						<ul>
        							<li><a href="Ticket.jsp">티켓 예매</a></li>
        							<li><a href= "">시즌티켓</a></li>
	...
	<div id="main">
		...
		<div style="clear:both;"></div>
			<div class="page">
				<a href="Servlet?command=notice&page=<%=pageNum - 1%>"></a>
				<%
				...
				if(pageNum == maxCount){
				%>
				<a href="Servlet?command=notice&page=<%=maxCount%>"></a>
				<%
				} else {
				%>
				<a href="Servlet?command=notice&page=<%=pageNum + 1%>"></a>
				...
				<script>
					$(function() {
					  ...
					  $("#write").click(function(){
						 location.href="Servlet?command=noticeWritePage"; 
					  });
					});
				</script>
			</div>
